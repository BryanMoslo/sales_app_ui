    ...
    return (
        <>
            <div className="flex">
                ...
                <div className="translate-x-0 ease-out fixed inset-y-0 left-0 z-30 w-64 overflow-y-auto transition duration-300 transform bg-gray-900 lg:translate-x-0 lg:static lg:inset-0">
                <div className="flex items-center justify-center mt-8">
                    ...
                    <span className="mx-2 text-2xl font-semibold text-white">Sales App</span>
                    </div>
                </div>
