        ...
        <Form title="Create a client" onSubmit={handleSubmit} >
            <div className="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <input className="w-full mt-2 h-11 border-gray-200 rounded-md focus:border-indigo-600 focus:ring focus:ring-opacity-40 focus:ring-indigo-500" type="text" name="rep" value={client.representative} placeholder="Rep" onChange={handleInputChange}/>
                </div>
            </div>
        </Form>
    )
